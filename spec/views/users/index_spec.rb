...
RSpec.describe 'user index page', type: :feature do
  before(:each) do
    @user = User.create! name: 'user1', email: 'user1@example.com', password: 'password', confirmed_at: Time.now
    User.create! name: 'user2', email: 'user2@example.com', password: 'password', confirmed_at: Time.now
    @user.posts.create! title: 'Lorem ipsum', text: 'Lorem ipsum dolor sit amet'
